...
<div class="mid">
    <div class="left">
        <H1>Absolument immersif.</H1>
    </div>
    <div class="rigth">
        <H4>Phantom I 103 dB, avec sa Remote intègre l’ensemble des technologies de pointe Devialet pour
            ...
            puissante, plus extrême. Absolument immersif.</H4>
    </div>
</div>
