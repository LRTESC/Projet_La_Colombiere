...
<section>
    <div class="container-b3">
        <div>
            ...
            <p class="p-product-1">
                L'enceinte Phantom I déchaîne l'impact physique d'un son haute
                fidélité et ultra-dense avec <br>
                plus de puissance, de netteté et de précision que n'importe
                quelle autre enceinte connectée.
            </p>
        </div>
        ...
        <div>
            ...
            <p class="p-product-1">
                Phantom rassemble des technologies révolutionnaires pour offrir
                une expérience d'écoute <br>
...
<section>
    <div class="implosivdiv">
        <img class="implosivimg"
             src="{{asset('storage/pictures/implosivimg.png')}}"
             alt="implosivimg">
    </div>
</section>
        ...
        @foreach ($products as $product)
            <div class="product-c">
                <div class="img-space-around">
                    <img class="img-space-product"
                         src="{{asset('storage/pictures/' . $product->picture)}}"
                         alt="Product">
                </div>
                <div class="product-d-1">
                    ...
                    <div class="div-button">
                        <a href="{{route('productid',['id' =>
                                $product->id])}}">
                            <button
                                class="buy-button-product">Voir
                            </button>
                        </a>
                    </div>
                </div>
